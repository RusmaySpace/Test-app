...
def P():
  ...
  if end in "меню":
    ...
    if Z in "1":
      ...
      print("\nЧто-то пошло не так. Возможно вы ввели некорректный номер запроса или поставили лишний пробел.\n")
      G()
  elif end in "конец":
    print(Fore.LIGHTGREEN_EX + "\nСпасибо за тест моей программы, до новых встреч!\n")
  else:
    print(Fore.RED + "\nЯ не понял вашу команду, возможно вы ошиблись в её написании, или поставили лишний пробел. Доступные команды: меню, повторить и конец.\n")
...
def Disk():
  print(Fore.LIGHTRED_EX + "\nВы выбрали: расчет по формуле дискриминанта.\n")
  ...
  dc = int(input(Fore.RESET + "Введите значение c: \n" + Fore.CYAN))
  sum = (db**2 - 4 * da * dc)
  print("D = ", + sum)
